...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func login(){
        let phoneNum : String? = UserDefaults.standard.string(forKey: "phoneNum")
        print(phoneNum)
        if phoneNum != nil {
            let storyBoard = UIStoryboard(name: "Main", bundle: nil)
            let TabBarVC = storyBoard.instantiateViewController(withIdentifier: "TabBarVC") as! TarBarVC
